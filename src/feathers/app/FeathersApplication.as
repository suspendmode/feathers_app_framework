...
public class FeathersApplication extends Sprite {
     ...
     *
     */
    public function FeathersApplication() {
        super();
        setupNativeStage();
        initializeLogger();
	}
	 ...
	 * 
	 * @param splashConfig
	 * @param feathersConfig
	 * @param designConfig
	 * 
	 */
	protected function setupApplication(feathersConfig:FeathersConfig = null, designConfig:DesignConfig = null): void {
	...
	protected function setupSplash(splashConfig:SplashConfig = null): void {
    ...
    private function initializeSplash():void {
        if (!splashConfig) {
            return;
        }
		config::debug {
    ...
    private function initializeScreenScale():void {
        ...
        if (!screenScale) {
            screenScale = new ScreenScale(designConfig.width, designConfig.height, designConfig.ppi, stage, feathersConfig.simulateScale, feathersConfig.simulatedScale);
